      ...
      >
        ...
        <div className="container flex flex-col items-start justify-center tracking-wide text-black dark:text-white">
          <div className="container relative flex h-full w-full flex-col items-center">
            <div className=" font-serif text-[#06314f] h-72 w-[280px] text-center text-[2rem] font-extrabold sm:w-[520px] md:w-[700px] lg:mb-5 lg:w-[920px] lg:text-[3rem]">
              <motion.span
              ...
              <br />
              <TextAnimation delay={1} baseText={`I’m Siva...`} />
            </div>
            <motion.div
            ...
            >
              <a
                className="group flex w-64 cursor-pointer items-center justify-center gap-2 rounded-full bg-[#06314f] px-7 py-3 text-white outline-none transition hover:bg-lightBeige hover:text-black hover:dark:text-black sm:w-auto"
                onClick={(e) => {
             ...
             <a
                href="/SIVASANKAR_SOFTWARE_DEVELOPER.pdf"
                download="SIVASANKAR_SOFTWARE_DEVELOPER.pdf"
              ...
              <div className="flex gap-2">
                <a
                  ...
                  href="https://www.linkedin.com/in/sivasankar-b-dev/"
                  target="_blank"
                >
                  <Image
                    width={25}
                ...
                <a
                  ...
                  href="https://github.com/sivasankar-webdev"
                  target="_blank"
                >
                  <Image
                    width={25}
